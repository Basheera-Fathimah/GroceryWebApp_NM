        ...
        <div>
            {isAdmin ?
                <Navbar fixed="top" style={{ padding: '0 20px', minHeight: '10vh', width: '100%',backgroundColor:"red" }} expand="lg" bg="light" variant="light">
                    <Navbar.Brand><Link to='/admin/dashboard' style={{ textDecoration: 'none' }}>GROCIO</Link></Navbar.Brand>
                ...
                <Navbar fixed="top" style={{ padding: '0 20px', minHeight: '10vh', width: '100%',backgroundColor:"#2e8fbf" }} expand="lg" >
                    <Navbar.Brand><Link to='/' style={{ textDecoration: 'none',color:"#0a0a0a"}}>GROCIO</Link></Navbar.Brand>
                    <Navbar.Toggle aria-controls="navbarSupportedContent" />
                    <Navbar.Collapse id="navbarSupportedContent">
                        <Nav className="mr-auto">
